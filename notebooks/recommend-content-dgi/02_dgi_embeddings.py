...
plot_model(model, show_shapes=True, to_file="model_adjust.png")
...
dgi_embeddings_df.to_csv('data/processed/dgi_embeddings_df.csv', index=False, header=True, mode='w')
